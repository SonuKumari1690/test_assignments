...
while True:
    ...
    if framecounter > 1:
        ...
        for c in cnts:
            ...
            initBB2 =(x,y,w,h)
            prott1 = r'/home/prabhat/backups/video_files/MobileNet-SSD-master/voc/MobileNetSSD_deploy.prototxt'
            prott2 = r'/home/prabhat/backups/video_files/mobilenet_iter_73000.caffemodel'
